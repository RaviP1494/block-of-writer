...
import { allStreams, chainTargetID, createNewChain, createNewStream, focusedChainID, focusedStreamID, openChains, openStreams, setChainTargetID, setFocusedChainID, setFocusedStreamID, setOpenChains, setOpenStreams, setWriterTargetID, sparkChains, writerTargetID } from '../store';
...
export const Lister: Component<ListerProps> = (props) => {
  ...
  const handleCreate = () => {
    ...
    props.of === 'viewspaces' ? createNewStream(createName()) : null;
    setCreateName('');
  };
